...
echo "128 1 1 1 1 grid 401 61 121 10 10 10 4650 0 -600 1 2" >> $output
...
echo "TTREE param" > $output
echo $gridparamtitle >> $output
echo "128 1 1 1 1 grid 166 25 49 10 10 10 3000 0 -240 1 2" >> $output
echo "TTREE data" >> $output
echo $griddatatitle >> $output
gawk '{if ($1!="x"&&$1!="#") print (7650-$1)" "($2)" "($3)" "($4)" "($5)" "($6);}' $input >> $output
txt2root $output $output.root
...
echo "TTREE param" > $output
echo $gridparamtitle >> $output
echo "128 1 1 1 1 grid 325 25 325 10 10 10 -240 0 -240 1 2" >> $output
echo "TTREE data" >> $output
echo $griddatatitle >> $output
gawk '{delta=(sqrt((4650-$1)*(4650-$1)+(3000+$3)*(3000+$3))-3000);if ($1!="x"&&$1!="#"&&delta<300&&delta>-300) print (7650-$1)" "($2)" "(-$3)" "($4)" "($5)" "($6);}' $input >> $output
txt2root $output $output.root
...
echo "TTREE param" > $output
echo $gridparamtitle >> $output
echo "128 1 1 1 1 grid 325 25 325 10 10 10 -240 0 -240 1 0" >> $output
echo "TTREE data" >> $output
echo $griddatatitle >> $output
gawk '{delta=(sqrt((4650-$1)*(4650-$1)+(3000+$3)*(3000+$3))-3000);if ($1!="x"&&$1!="#"&&delta<300&&delta>-300) print (7650-$1)" "($2)" "(-$3)" "0" "1" "0;}' $input >> $output
txt2root $output $output.root
...
echo "TTREE param" > $output
echo $gridparamtitle >> $output
echo "128 1 1 1 1 grid 49 25 201 10 10 10 -240 0 3000 1 2" >> $output
echo "TTREE data" >> $output
echo $griddatatitle >> $output
gawk '{if ($1!="x"&&$1!="#") print (7650-$1)" "($2)" "(-$3)" "($4)" "($5)" "($6);}' $input >> $output
txt2root $output $output.root
...
echo "TTREE param" > $output
echo $gridparamtitle >> $output
echo "128 1 1 1 1 grid 201 101 401 10 10 10 -1000 0 5000 1 2" >> $output
echo "TTREE data" >> $output
echo $griddatatitle >> $output
gawk '{if ($1!="x"&&$1!="#") print (7650-$1)" "($2)" "(-$3)" "($4)" "($5)" "($6);}' $input >> $output
txt2root $output $output.root
