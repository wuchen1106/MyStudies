...
for configName in "g40cm10mm182gcm3_03T"
do
...
#			for pname in "em" "mum" "pim" "n0"
			...
			do
				...
				if [ $configName = "g60cm6mm_170gcm3" -o $configName = "g60cm6mm_200gcm3" -o $configName = "g40cm10mm182gcm3" -o $configName = "g40cm10mm182gcm3_03T" ]; then
