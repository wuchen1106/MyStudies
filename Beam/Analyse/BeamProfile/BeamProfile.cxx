...
int main(int argc, char** argv){
	...
	for (int iHist = 0; iHist < nHists; iHist++ ){
		...
		name_temp = m_prefix+"_"+name+"_log"+m_suffix;
		miny_temp = m_miny;
		ylog_temp = 1;
	...
	for( Long64_t iEvent = 0; iEvent < (nEvents&&nEvents<nEvent?nEvents:nEvent); iEvent++ ){
		...
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pa"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(pa/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pt"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(pt/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pz"+m_suffix);
		if (index_temp!=-1)	fMyRootInterface->get_TH1D(index_temp)->Fill(pz/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pa_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(pa/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pt_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(pt/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pz_tail"+m_suffix);
		if (index_temp!=-1)	fMyRootInterface->get_TH1D(index_temp)->Fill(pz/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"theta"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(theta/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"gTime"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(t/ns);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"gTime_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(t/ns);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"r"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(r/mm);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"y"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(y/mm);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"ox"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(ox/mm);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"oy"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(oy/mm);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"oz"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(oz/mm);

		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pa"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(pa/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pt"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(pt/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pz"+"_log"+m_suffix);
		if (index_temp!=-1)	fMyRootInterface->get_TH1D(index_temp)->Fill(pz/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pa_tail"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(pa/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pt_tail"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(pt/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"pz_tail"+"_log"+m_suffix);
		if (index_temp!=-1)	fMyRootInterface->get_TH1D(index_temp)->Fill(pz/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"theta"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(theta/MeV);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"gTime"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(t/ns);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"gTime_tail"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(t/ns);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"r"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(r/mm);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"y"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(y/mm);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"ox"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(ox/mm);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"oy"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(oy/mm);
		index_temp = fMyRootInterface->get_TH1D_index(m_prefix+"_"+"oz"+"_log"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH1D(index_temp)->Fill(oz/mm);

		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"thetar"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(theta/rad,r/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"patheta"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,theta/rad);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"oxoy"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(ox/mm,oy/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"oxoz"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(ox/mm,oz/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"paox"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,ox/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"ptox"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pt/MeV,ox/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"pzox"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pz/MeV,ox/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"paoy"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,oy/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"pay"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,y/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"ptoy"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pt/MeV,oy/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"pzoy"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pz/MeV,oy/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"paoz"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,oz/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"ptoz"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pt/MeV,oz/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"pzoz"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pz/MeV,oz/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"par"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,r/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"ptr"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pt/MeV,r/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"pzr"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pz/MeV,r/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"patheta_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,theta/rad);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"paox_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,ox/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"ptox_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pt/MeV,ox/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"pzox_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pz/MeV,ox/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"paoy_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,oy/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"ptoy_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pt/MeV,oy/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"pzoy_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pz/MeV,oy/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"paoz_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,oz/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"ptoz_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pt/MeV,oz/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"pzoz_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pz/MeV,oz/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"par_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pa/MeV,r/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"ptr_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pt/MeV,r/mm);
		index_temp = fMyRootInterface->get_TH2D_index(m_prefix+"_"+"pzr_tail"+m_suffix);
		if (index_temp!=-1) fMyRootInterface->get_TH2D(index_temp)->Fill(pz/MeV,r/mm);
