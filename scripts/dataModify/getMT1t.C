{
	...
	for (int i = 0; i<1; i++){
		...
		double nProtons = 1;
		if (i==0){
//			f = new TFile("MT1.EP.em.g40cm10mm.003T.g4s.QBH.root");
//			nProtons = 2E7;
			f = new TFile("MT1.EP.t16cm6mm.003TS.g4s.QBH.root");
			nProtons = 2E6;
//			f = new TFile("MT1.EP.g40cm10mm.0018TS.g4s.QBH.root");
//			f = new TFile("MT1.EP.g40cm10mm.0018TS.cg4.QB.root");
		}
//		else if (i==1){
//			f = new TFile("MT1.EP.mum.g40cm10mm.003T.g4s.QBH.root");
//			nProtons = 2E7;
//		}
//		else if (i==2){
//			f = new TFile("MT1.pim.pim.g40cm10mm.003T.g4s.QBH.root");
//			nProtons = 1E9;
//		}
//		else{
//			f = new TFile("MT1.EP.OT.g40cm10mm.003T.g4s.QBH.root");
//			nProtons = 2E7;
//		}
		double weight = 1;
		double px;
...
//	maximum*=2;
	...
	for (int i = 0; i<pids.size(); i++){
		...
		hists[i]->GetYaxis()->SetRangeUser(1e-7,maximum);
		if (i==0){
			hists[i]->SetTitle("Particles at The End of The First 90 Degree (Tungsten, 16cm, 0.03 T)");
//			hists[i]->SetTitle("Particles at The End of The First 90 Degree (Graphite, 40cm, 0.03 T)");
			hists[i]->Draw();
		}
